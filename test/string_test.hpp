...
test(string_poolstring)
{
    ...
    string1 = "12345678901234567890123456789012345678901234567890123456789012345678901234567890";
    assertTrue(string1 == "1234567890123456789012345678901234567890123456789012345678901234");

    string2 = string1;
    assertTrue(string1 == "1234567890123456789012345678901234567890123456789012345678901234");
    
    PoolString<decltype(stringPool)> string3(string1);
    assertTrue(string3 == "1234567890123456789012345678901234567890123456789012345678901234");
